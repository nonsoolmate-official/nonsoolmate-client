...
export const UNIV_LIST: UnivListTypes[] = [
  ...
  { id: 4, univ: "경희대", details: "(사회/인문체육)", img: Univ4Ic },
  { id: 5, univ: "서강대", img: Univ5Ic },
  { id: 6, univ: "성균관대", img: Univ6Ic },
  { id: 7, univ: "중앙대", img: Univ7Ic },
  { id: 8, univ: "한국외대", img: Univ8Ic },
  { id: 9, univ: "한양대", img: Univ9Ic },
];
